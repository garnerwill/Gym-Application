namespace GYM_APP.Migrations
{
    ...
    public partial class look : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Gyms", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Customers", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Calenders", "ApplicationUserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.Instructors", new[] { "ApplicationUserId" });
            DropIndex("dbo.Gyms", new[] { "ApplicationUserId" });
            ...
            DropIndex("dbo.Calenders", new[] { "ApplicationUserId" });
